...
/****** Object:  StoredProcedure [dbo].[sp_region_guardar]    Script Date: 02/27/2018 19:27:29 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[sp_region_guardar]
	@xmlParam xml	
AS
BEGIN
    ...
    BEGIN
		BEGIN TRY
			BEGIN TRANSACTION;
				...
				INSERT INTO [Cartera_Agregada_AFP].[dbo].[TbRegion]
					   ([nombre]
					   ,[subregion]
					   ,[mercado])
